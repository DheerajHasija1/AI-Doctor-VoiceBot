...
def process_inputs(audio_filepath, image_filepath):
    ...
    audio_output_path = "final.mp3"
     ...
     # Use either gTTS or ElevenLabs (uncomment the one you want)
    voice_of_doctor = text_to_speech_with_gtts(input_text=doctor_response, output_filepath=audio_output_path)
    # voice_of_doctor = text_to_speech_with_elevenlabs(input_text=doctor_response, output_filepath=audio_output_path)
